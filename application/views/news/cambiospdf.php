		...
		<?php
			while ($fila = $resultado -> fetch_array()){
				...
				<tr>
					...
					<td><input type="text" name="pais" class="form-control" value="' .$fila['moneda_origen'] .'"></td>
					<td><input type="text" name="email" class="form-control" value="' .$fila['moneda_cambio'] .'"></td>
					<td><input type="text" name="extranjero" class="form-control" value="' .$fila['cantidad'] .'"></td>
					<td><input type="text" name="mexicano" class="form-control" value="' .$fila['total'] .'"></td>
				</tr>';
